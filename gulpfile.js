...
gulp.task('default', function(callback) {
	runSequence('clean', ['plugins', 'scripts', 'styles', 'images', 'html', 'fonts'], 'open', callback);
	...
	gulp.watch(config.src_fonts, ['fonts'])._watcher.on('all', livereload);
});